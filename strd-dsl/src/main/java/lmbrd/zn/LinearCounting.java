...
public class LinearCounting {
    ...
    public boolean offer(byte[] o) {
        ...
        long hash = (long) BytesHash.instance.computeHashCode(o); //MurmurHash.hash(o);
     ...
     */
    public LinearCounting merge(LinearCounting... estimators) {
/*
        if (estimators == null) {
...
*/
    ...
    protected static class LinearCountingMergeException extends RuntimeException {
